...
T = {
    ...
    # ── Captura de conocimiento (Quirón) ──
    "sup.tab.capture":         {"es": "Enseñar a Mythos",       "en": "Teach Mythos",          "pt": "Ensinar ao Mythos"},
    "sup.capture.title":       {"es": "Captura de conocimiento — Quirón", "en": "Knowledge capture — Quirón", "pt": "Captura de conhecimento — Quirón"},
    "sup.capture.intro":       {"es": "¿No tenés tiempo de explicar lo mismo una y otra vez? Enseñale a Mythos una sola vez. Quirón te hace preguntas guiadas, convierte tus respuestas en documentación y la deja disponible para que el asistente responda a los empleados por vos.",
                                 "en": "No time to explain the same thing over and over? Teach Mythos once. Quirón asks you guided questions, turns your answers into documentation and makes it available so the assistant answers employees for you.",
                                 "pt": "Sem tempo para explicar a mesma coisa repetidamente? Ensine ao Mythos uma vez. Quirón faz perguntas guiadas, transforma suas respostas em documentação e a disponibiliza para que o assistente responda aos funcionários por você."},
    ...
    "sup.capture.generating":  {"es": "Quirón preparando preguntas...", "en": "Quirón preparing questions...", "pt": "Quirón preparando perguntas..."},
    ...
    "sup.capture.answers_hint":{"es": "Respondé con tus palabras. No hace falta completar todas: Quirón usa lo que escribas.",
                                 "en": "Answer in your own words. You don't need to fill them all: Quirón uses whatever you write.",
                                 "pt": "Responda com suas palavras. Não precisa preencher todas: Quirón usa o que você escrever."},
    "sup.capture.save":        {"es": "Enseñar a Mythos",       "en": "Teach Mythos",          "pt": "Ensinar ao Mythos"},
    "sup.capture.saving":      {"es": "Quirón documentando e indexando...", "en": "Quirón documenting and indexing...", "pt": "Quirón documentando e indexando..."},
    ...
    "sup.capture.error":       {"es": "Quirón tuvo un problema. Reintentá en un momento.", "en": "Quirón had a problem. Retry in a moment.", "pt": "Quirón teve um problema. Tente novamente em instantes."},
    "sup.capture.quota":       {"es": "Quirón alcanzó el límite de consultas. Esperá unos minutos.", "en": "Quirón reached the query limit. Wait a few minutes.", "pt": "Quirón atingiu o limite de consultas. Aguarde alguns minutos."},
    ...
    # ── Supervisor: KPIs, gráficos y métricas ──
    "sup.kpi.breaches":        {"es": "Brechas detectadas",     "en": "Detected breaches",     "pt": "Lacunas detectadas"},
    "sup.kpi.breaches_sub":    {"es": "Comprensión insuficiente", "en": "Insufficient understanding", "pt": "Compreensão insuficiente"},
    "sup.kpi.notver":          {"es": "No verificadas",         "en": "Not verified",          "pt": "Não verificadas"},
    "sup.kpi.notver_sub":      {"es": "Señales de superficialidad", "en": "Signs of superficiality", "pt": "Sinais de superficialidade"},
    "sup.kpi.stalled":         {"es": "Estancados >3 días",     "en": "Stalled >3 days",       "pt": "Parados >3 dias"},
    "sup.kpi.stalled_sub":     {"es": "Sin avance reciente",    "en": "No recent progress",    "pt": "Sem progresso recente"},
    "sup.kpi.active":          {"es": "Empleados activos",      "en": "Active employees",      "pt": "Funcionários ativos"},
    "sup.kpi.avg":             {"es": "Progreso promedio",      "en": "Average progress",      "pt": "Progresso médio"},
    "sup.kpi.with_breach":     {"es": "Con brecha detectada",   "en": "With detected breach",  "pt": "Com lacuna detectada"},
    "sup.kpi.done":            {"es": "Ruta completada",        "en": "Route completed",       "pt": "Rota concluída"},
    "sup.badge.stalled":       {"es": "ESTANCADO",              "en": "STALLED",               "pt": "PARADO"},
    "sup.badge.breach":        {"es": "BRECHA DETECTADA",       "en": "BREACH DETECTED",       "pt": "LACUNA DETECTADA"},
    "sup.badge.notver":        {"es": "NO VERIFICADA",          "en": "NOT VERIFIED",          "pt": "NÃO VERIFICADA"},
    "sup.card.not_understood": {"es": "Conceptos NO comprendidos", "en": "Concepts NOT understood", "pt": "Conceitos NÃO compreendidos"},
    "sup.card.understood":     {"es": "Conceptos sí comprendidos", "en": "Concepts understood", "pt": "Conceitos compreendidos"},
    "sup.card.action_sup":     {"es": "Acción sugerida al supervisor", "en": "Suggested action for supervisor", "pt": "Ação sugerida ao supervisor"},
    "sup.metric.time":         {"es": "Tiempo dedicado",        "en": "Time spent",            "pt": "Tempo dedicado"},
    "sup.metric.min":          {"es": "mínimo",                 "en": "minimum",               "pt": "mínimo"},
    "sup.metric.est":          {"es": "estimado",               "en": "estimated",             "pt": "estimado"},
    "sup.metric.quiz":         {"es": "Puntaje del cuestionario", "en": "Quiz score",          "pt": "Pontuação do quiz"},
    "sup.metric.of":           {"es": "de",                     "en": "of",                    "pt": "de"},
    "sup.metric.consultas":    {"es": "Consultas al asistente", "en": "Assistant queries",     "pt": "Consultas ao assistente"},
    "sup.metric.ideal":        {"es": "ideal: 3 a 6",           "en": "ideal: 3 to 6",         "pt": "ideal: 3 a 6"},
    "sup.overview.detail":     {"es": "Detalle por empleado",   "en": "Detail by employee",    "pt": "Detalhe por funcionário"},
    "sup.overview.breaches_n": {"es": "brecha(s)",              "en": "breach(es)",            "pt": "lacuna(s)"},
    "sup.chart.progress":      {"es": "Progreso por empleado",  "en": "Progress by employee",  "pt": "Progresso por funcionário"},
    "sup.chart.diagnosis":     {"es": "Distribución de diagnósticos", "en": "Diagnosis distribution", "pt": "Distribuição de diagnósticos"},
    "sup.chart.heatmap":       {"es": "Mapa de comprensión: empleados × módulos", "en": "Understanding map: employees × modules", "pt": "Mapa de compreensão: funcionários × módulos"},
    "sup.chart.time_min":      {"es": "Tiempo dedicado (min)",  "en": "Time spent (min)",      "pt": "Tempo dedicado (min)"},
    "sup.chart.quiz_pct":      {"es": "Puntaje del cuestionario (%)", "en": "Quiz score (%)",  "pt": "Pontuação do quiz (%)"},
    "sup.chart.evaluated":     {"es": "evaluados",              "en": "evaluated",             "pt": "avaliados"},
    "sup.status.pending":      {"es": "Pendiente",              "en": "Pending",               "pt": "Pendente"},
