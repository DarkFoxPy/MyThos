...
T = {
    ...
    # ── Captura de conocimiento (Mnemosyne) ──
    "sup.tab.capture":         {"es": "Enseñar a Mythos",       "en": "Teach Mythos",          "pt": "Ensinar ao Mythos"},
    "sup.capture.title":       {"es": "Captura de conocimiento — Mnemosyne", "en": "Knowledge capture — Mnemosyne", "pt": "Captura de conhecimento — Mnemosyne"},
    "sup.capture.intro":       {"es": "¿No tenés tiempo de explicar lo mismo una y otra vez? Enseñale a Mythos una sola vez. Mnemosyne te hace preguntas guiadas, convierte tus respuestas en documentación y la deja disponible para que el asistente responda a los empleados por vos.",
                                 "en": "No time to explain the same thing over and over? Teach Mythos once. Mnemosyne asks you guided questions, turns your answers into documentation and makes it available so the assistant answers employees for you.",
                                 "pt": "Sem tempo para explicar a mesma coisa repetidamente? Ensine ao Mythos uma vez. Mnemosyne faz perguntas guiadas, transforma suas respostas em documentação e a disponibiliza para que o assistente responda aos funcionários por você."},
    ...
    "sup.capture.generating":  {"es": "Mnemosyne preparando preguntas...", "en": "Mnemosyne preparing questions...", "pt": "Mnemosyne preparando perguntas..."},
    ...
    "sup.capture.answers_hint":{"es": "Respondé con tus palabras. No hace falta completar todas: Mnemosyne usa lo que escribas.",
                                 "en": "Answer in your own words. You don't need to fill them all: Mnemosyne uses whatever you write.",
                                 "pt": "Responda com suas palavras. Não precisa preencher todas: Mnemosyne usa o que você escrever."},
    "sup.capture.save":        {"es": "Enseñar a Mythos",       "en": "Teach Mythos",          "pt": "Ensinar ao Mythos"},
    "sup.capture.saving":      {"es": "Mnemosyne documentando e indexando...", "en": "Mnemosyne documenting and indexing...", "pt": "Mnemosyne documentando e indexando..."},
    ...
    "sup.capture.error":       {"es": "Mnemosyne tuvo un problema. Reintentá en un momento.", "en": "Mnemosyne had a problem. Retry in a moment.", "pt": "Mnemosyne teve um problema. Tente novamente em instantes."},
    "sup.capture.quota":       {"es": "Mnemosyne alcanzó el límite de consultas. Esperá unos minutos.", "en": "Mnemosyne reached the query limit. Wait a few minutes.", "pt": "Mnemosyne atingiu o limite de consultas. Aguarde alguns minutos."},
